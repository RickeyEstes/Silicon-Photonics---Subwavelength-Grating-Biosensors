...
\vspace{-1em}
%As silicon photonic devices are compatible with existing CMOS foundry processes, ORR biosensors are well-suited for the front-line of real-time medical diagnostics, such as early detection, drug testing, blood typing, and more. 
